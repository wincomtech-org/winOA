...
INSERT INTO `cmf_admin_menu` VALUES ('166', '163', '1', '0', '10000', 'wdata', 'AdminWdata', 'edit', '', '编辑网站', '', '编辑网站');
INSERT INTO `cmf_admin_menu` VALUES ('167', '163', '2', '0', '10000', 'wdata', 'AdminWdata', 'editPost', '', '编辑网站提交', '', '编辑网站提交');
INSERT INTO `cmf_admin_menu` VALUES ('168', '163', '2', '0', '10000', 'wdata', 'AdminWdata', 'listOrder', '', '网站排序', '', '网站排序');
INSERT INTO `cmf_admin_menu` VALUES ('169', '163', '2', '0', '10000', 'wdata', 'AdminWdata', 'delete', '', '删除网站', '', '删除网站');
...
INSERT INTO `cmf_auth_rule` VALUES ('162', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/default', '', '网站资源', '');
INSERT INTO `cmf_auth_rule` VALUES ('163', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/index', '', '网站管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('164', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/add', '', '添加网站', '');
INSERT INTO `cmf_auth_rule` VALUES ('165', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/addPost', '', '添加网站提交', '');
INSERT INTO `cmf_auth_rule` VALUES ('166', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/edit', '', '编辑网站', '');
INSERT INTO `cmf_auth_rule` VALUES ('167', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/editPost', '', '编辑网站提交', '');
INSERT INTO `cmf_auth_rule` VALUES ('168', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/listOrder', '', '网站排序', '');
INSERT INTO `cmf_auth_rule` VALUES ('169', '1', 'wdata', 'admin_url', 'wdata/AdminWdata/delete', '', '删除网站', '');
...
-- ----------------------------
INSERT INTO `cmf_option` VALUES ('1', '1', 'site_info', '{\"site_name\":\"\\u534e\\u521b\\u667a\\u80fd\\u529e\\u516c\\u7cfb\\u7edf\",\"site_seo_title\":\"\\u534e\\u521b\\u667a\\u80fd\\u529e\\u516c\\u7cfb\\u7edf\",\"site_seo_keywords\":\"\\u534e\\u521b,\\u529e\\u516c,\\u6570\\u636e,php,cmf,cms\",\"site_seo_description\":\"\\u534e\\u521b\\u5728\\u7ebf\\u670d\\u52a1\\u9886\\u57df\\u6db5\\u76d6\\u7f51\\u7ad9\\u5efa\\u8bbe\\uff0c\\u4f01\\u4e1a\\u5b9a\\u5236\\u5316\\u7cfb\\u7edf\\uff0cAPP\\u5f00\\u53d1\\uff0c\\u5fae\\u4fe1\\u516c\\u4f17\\u53f7\\u4e8c\\u6b21\\u5f00\\u53d1\\uff0c\\u5546\\u57ce\\u7f51\\u7ad9\\u5f00\\u53d1\\uff0c\\u7535\\u5b50\\u5546\\u52a1\\u5b9a\\u5236\\uff0c\\u767e\\u5ea6\\u63a8\\u5e7f\\u670d\\u52a1\\u7b49\\u3002\"}');
INSERT INTO `cmf_option` VALUES ('2', '1', 'smtp_setting', '{\"from_name\":\"531597796\",\"from\":\"531597796@qq.com\",\"host\":\"smtp.qq.com\",\"smtp_secure\":\"\",\"port\":\"25\",\"username\":\"win\",\"password\":\"win@123\"}');
...
-- ----------------------------
INSERT INTO `cmf_user_token` VALUES ('1', '1', '1538280308', '1522728308', 'f0d306e4c2659280166f697788059d82f0d306e4c2659280166f697788059d82', 'web');
...
CREATE TABLE `cmf_wdata` (
  ...
  `name` varchar(60) NOT NULL DEFAULT '' COMMENT '网站名称',
  ...
  `dev_ini` varchar(255) DEFAULT '' COMMENT '文件配置相对路径',
  `db` varchar(30) NOT NULL DEFAULT '' COMMENT '数据库名',
